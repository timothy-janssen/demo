...
app.get('/', function (req, res) {
    ...
    res.end(`
        ...
        <div style="text-align:center;"><b style="display:inline-block; text-align:center; color:white; background-color: red;">Your challenge: Find 10 sentences I don't understand</b></div>
